<template>
  ...
  >
    <div class="track" :class="{ dark: isDark }">
      ...
      <div class="thumb" :class="{ active: isDark }" />
    </div>
  </button>
</template>
...
.sun-icon { color: #c9a96e; opacity: 1; }
.moon-icon { color: #6e6a64; opacity: 0.5; }

.track.dark .sun-icon  { color: #c9a96e; opacity: 0.4; }
.track.dark .moon-icon { color: #0b0b0e; opacity: 1; }
